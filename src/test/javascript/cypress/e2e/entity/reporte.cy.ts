...
describe('Reporte e2e test', () => {
  ...
  const reporteSample = { descripcion: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', fecha: '2023-02-24T18:42:06.295Z' };
  ...
  describe('new Reporte page', () => {
    ...
    it('should create an instance of Reporte', () => {
      ...
      cy.get(`[data-cy="fecha"]`).type('2023-02-24T22:40').blur().should('have.value', '2023-02-24T22:40');
