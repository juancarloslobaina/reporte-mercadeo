...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.labreferencia.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.labreferencia.security.DomainUserDetailsService", "createSpringSecurityUser");
