...
public interface ReporteRepository extends JpaRepository<Reporte, Long> {
    ...
    @Query(
        value = "select distinct reporte from Reporte reporte left join fetch reporte.doctor left join fetch reporte.centroMedico",
    ...
    @Query("select distinct reporte from Reporte reporte left join fetch reporte.doctor left join fetch reporte.centroMedico")
    List<Reporte> findAllWithToOneRelationships();

    @Query("select reporte from Reporte reporte left join fetch reporte.doctor left join fetch reporte.centroMedico where reporte.id =:id")
