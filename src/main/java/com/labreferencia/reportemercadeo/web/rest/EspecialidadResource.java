...
import com.labreferencia.reportemercadeo.service.EspecialidadService;
...
/**
 * REST controller for managing {@link com.labreferencia.reportemercadeo.domain.Especialidad}.
 */
@RestController
@RequestMapping("/api")
public class EspecialidadResource {
    ...
    public ResponseEntity<List<EspecialidadDTO>> getAllEspecialidads(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
