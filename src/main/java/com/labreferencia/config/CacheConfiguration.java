package com.labreferencia.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.labreferencia.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.labreferencia.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.labreferencia.domain.Doctor.class.getName());
            createCache(cm, com.labreferencia.domain.Reporte.class.getName());
