...
public class CentroServiceImpl implements CentroService {
    ...
    @Override
    public Page<CentroDTO> findByUserLogin(String currentUsername, Pageable pageable) {
        log.debug("Request to get all Centros by User : {}", currentUsername);
        return centroRepository.findByUserLogin(currentUsername, pageable).map(centroMapper::toDto);
    }
}
