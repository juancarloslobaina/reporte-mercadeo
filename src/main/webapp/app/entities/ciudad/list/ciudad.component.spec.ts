...
describe('Ciudad Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ciudad', component: CiudadComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to ciudadService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCiudadIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCiudadIdentifier).toHaveBeenCalledWith(entity);
