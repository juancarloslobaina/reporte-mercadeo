...
export class CentroMedicoService {
  ...
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/centro-medicos');
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<ICentroMedico[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
